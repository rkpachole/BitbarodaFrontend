...
function Index() {
  ...
  const [editCourse, setSelectedCourse] = useState("");
  const [selectedValues, setselectedValues] = useState("");

  const [brochureImg, setbrochureImg] = useState([]);
  const { id } = useParams();
  ...
  useEffect(() => {
    const initialFormData = subCourse.map((course) => ({
      Subcourse: course.name,
      lactureReport: course.lactureReport,
      Duration: course.duration,
      lab: course.lab,
      theory: course.theory,
      notavailable: course.notavailable,
    }));
    setFormData(initialFormData);
  }, [subCourse]);
  const handleEditStepForm = () => {
    axios
      .get(`${BASE_URL}/course/get_One_Course/${id}`)
      .then((response) => {
        console.log(response.data.data);
        setSelectedOption(response.data.data.institute);
        setAdmissionFees(response.data.data.Admission);
        setAdmissionrn(response.data.data.Admission_RM);
        setAssignmentRm(response.data.data.Assignment_RM);
        setGstTaks(response.data.data.tax);
        setDgreProcess(response.data.data.Degree_Process_Fees);
        setExamEfh(response.data.data.Exam_EFH);
        setExamRg(response.data.data.Exam_RM);
        setLateFees(response.data.data.Late_Fees);
        setReReg_2(response.data.data.ReReg_2);
        setReReg3(response.data.data.ReReg_3);
        setSubCourse(response.data.data.Subcourse);
        setBackend(response.data.data.backendVisible);
        setSelected(response.data.data.frontendVisible);
        setBaseFees(response.data.data.baseFees);
        setSelectedOptions(response.data.data.category);
        setSelectValue(response.data.data.specialization.length);
        setbrochureImg(response.data.data.Brochure);
        setCertifictionName(response.data.data.certificateName);
        setCorporatePrice(response.data.data.corporateFees);
        setCourseDuration(response.data.data.courseDuration);
        setCourseType(response.data.data.courseGrop);
        setCourseName(response.data.data.courseName);
        setCourseType(response.data.data.courseType);
        setSelectedCountryValue(response.data.data.pageFormat);
        setSelectedUniversity(response.data.data.univercity);
        setSelectedCourse(response.data.data.laturesReport);
        setMetaDescription(response.data.data.metaDiscription);
        setMetaKeyBoard(response.data.data.metaKeyWords);
        setMetaTitle(response.data.data.metaTitle);
        setSelectedCourse(response.data.data.notavailable);
        setOfflinePrice(response.data.data.offlineFees);
        setOnlinePrice(response.data.data.onlineFees);
        setFileName(response.data.data.Brochure);
        setslugUrl(response.data.data.slugUrl);
        setLecture(response.data.data.specialization);
        setStudyMateria(response.data.data.studyMaterial_URL);
        setSelectedSubOptions(response.data.data.subCategory);
        setIsTheoryChecked(response.data.data.theory);
        // setUniversitiesList(response.data.data.subCategory.univercity)
  ...
  const handleSubmit = (event) => {
    ...
    const requestBody = {
      ...
      offlineFees: offlinePrice,
      metaKeyWords: valuesArray,
      onlineFees: onlinePrice,
      corporateFees: corporateprice,
      ...
      Admission: admissionfees ? admissionfees : 0,
      Admission_RM: admissionrn ? admissionrn : 0,
      ...
      slugUrl: slugUrl,
      pageFormat: selectedCountryValue,
    ...
    axios
      .post(`${BASE_URL}/course/edit_Course/${id}`, requestBody)
      .then((response) => {
        if (response.data.status === false) {
          setErrorMsg(response.data.message);
          setTimeout(() => {
                      ...
                      <div className="steps clearfix">
                        <ul role="tablist">
                          ...
                          >
                            <a
                              id="steps-uid-7-t-1"
                              href="#steps-uid-7-h-1"
                              aria-controls="steps-uid-7-p-1"
                            >
                              ...
                              <div className="row">
                                <div className="col-md-12">
                                  <div className="mb-3">
                                    ...
                                    />
                                       <div className="col-md-12">
                                  <div className="mb-3" style={{ textDecorationLine: "underline"}}>
                                  
                                  {
  selectedCountryValue === "page1" ? 
    <Link to="/course/page1" target="_blank">Course page1 Link</Link>
   :  selectedCountryValue === "page2" ? <Link to="/course/page2" target="_blank">Course page2 Link</Link>:selectedCountryValue === "page3"? 
    <Link to="/course/page3" target="_blank">Course Page3 Link</Link>:""
                                ...
                                <div className="col-md-12">
                                  <div className="mb-3">
                                    ...
                                    <Input
                                      type="text"
                                      value={metaKeyboard ? metaKeyboard : ""}
                        ...
                        {currentStep === 4 && (
                          <div>
                            ...
                            <section
                              id="steps-uid-7-p-1"
                              role="tabpanel"
                              aria-Labelledby="steps-uid-7-h-1"
                              className="body current "
                              aria-hidden="false"
                              style={{}}
                            >
